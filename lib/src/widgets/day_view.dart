...
class _DayViewState extends ZoomableHeadersWidgetState<DayView> {
  ...
  static const double _minEventHeight = 35.0; // Set a reasonable minimum height
  ...
  void createEventsDrawProperties() {
    ...
    for (FlutterWeekViewEvent event in List.of(events)) {
      ...
      // Ensure event has at least the minimum height
      if (drawProperties.height != null &&
          drawProperties.height! < _minEventHeight) {
        drawProperties.height = _minEventHeight;
      }
